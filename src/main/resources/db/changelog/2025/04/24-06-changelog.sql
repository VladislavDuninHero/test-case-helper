...
ALTER TABLE test_case_run_result
    ADD CONSTRAINT FK_TEST_CASE_RUN_RESULT_ON_TEST_CASE FOREIGN KEY (test_case_id) REFERENCES test_case (id);

-- changeset wladw:1748985182041-20
ALTER TABLE test_case_run_result
    ADD CONSTRAINT FK_TEST_CASE_RUN_RESULT_ON_TEST_SUITE_RUN_SESSION FOREIGN KEY (test_suite_run_session_id) REFERENCES test_suite_run_session (id);
...
ALTER TABLE test_suite_run_session
    ADD CONSTRAINT FK_TEST_SUITE_RUN_SESSION_ON_TEST_SUITE FOREIGN KEY (test_suite_id) REFERENCES test_suite (id);

-- changeset wladw:1748985182041-24
ALTER TABLE test_suite_run_session
    ADD CONSTRAINT FK_TEST_SUITE_RUN_SESSION_ON_USER FOREIGN KEY (user_id) REFERENCES users (id);